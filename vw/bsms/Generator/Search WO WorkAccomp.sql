...
--
select * from eqp.ProcNumbers where PROCID = 12881
select disid, 
...
from wo.WorkOrderMain where DISequip in (3895, 3896)
...
where PROCNUMBER = '1B11-2310-RB01'
...
exec [wAppTPM].[TPMTestGenerator] '02/18/2013'