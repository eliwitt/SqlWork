...
WHERE     (Contexts_AllReps.PrintFlag <> 0) AND (Letters_AllReps.MailDate IS NULL) AND (Letters_AllReps.AddresseeType = 'Representative') OR
                      (Contexts_AllReps.PrintFlag <> 0) AND (Letters_AllReps.AddresseeType = 'Representative') AND (Letters_AllReps.IndividualPrintedDate IS NULL)