-- productivity report the question is what to do with a person that seen but waives everything
-- there should be a record of it in the emp_employeeenrollmentperiod table but the enroller 
-- is not recorded in there.  Elizabeth here is that example.
