...
begin
	set @trapped = 30
	set @ErrorMsg = 'Error attempting to update msc_table 10 '
	goto Error_Handler
end
...
begin
	set @trapped = 31
	set @ErrorMsg = 'Error attempting to update msc_table 80  '
	goto Error_Handler
end
...
begin
	set @trapped = 32
	set @ErrorMsg = 'Error attempting to update msc_table 30  '
	goto Error_Handler
end
...
begin
	set @trapped = 33
	set @ErrorMsg = 'Error attempting to update msc_table 20 '
	goto Error_Handler
end
...
begin
	set @trapped = 34
	set @ErrorMsg = 'Error attempting to update msc_table 90  '
	goto Error_Handler
end
...
begin
	set @trapped = 36
	set @ErrorMsg = 'Error attempting to update msc_table 60 '
	goto Error_Handler
end
...
begin
	set @trapped = 39
	set @ErrorMsg = 'Error attempting to update msc_table 40 '
	goto Error_Handler
end
...
begin
	set @trapped = 40
	set @ErrorMsg = 'Error attempting to update msc_table 110 '
	goto Error_Handler
end
...
begin
	set @trapped = 42
	set @ErrorMsg = 'Error attempting to update msc_table 100 '
	goto Error_Handler
end
...
begin
	set @trapped = 44
	set @ErrorMsg = 'Error attempting to update msc_table 50 '
	goto Error_Handler
end
...
begin
	set @trapped = 46
	set @ErrorMsg = 'Error attempting to update msc_table 70 '
	goto Error_Handler
end
...
begin
	set @trapped = 79
	set @ErrorMsg = 'Error attempting to update msc_table 120 '
	goto Error_Handler
end
...
begin
	set @trapped = 113
	set @ErrorMsg = 'Error attempting to update msc_table 130 '
	goto Error_Handler
end
