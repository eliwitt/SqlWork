...
if @debug > 1
	print 'MULTISELECT'
INSERT INTO MSC_ValidValue (ValidType_key,ValidValue_vv,ValidValue_nm,Obsolete_flg)
VALUES ('371A93D1-08E1-4277-AEA0-67D36249E0C4','MULTISELECT','Multiselect','N')
--
-- error checking
--
if (@@error <> 0)
begin
	set @trapped = 29
	set @ErrorMsg = 'Error attempting to insert Answer Value MULTISELECT'
	goto Error_Handler
end
if @debug > 1
	print 'End of MULTISELECT'
--
...
insert into msc_table (table_nm, businessobject_nm, tableorder_num, 
templatedescription_txt, templatecolumns_txt) values 
	('ANS_AnswerGroupTransaction', 'AnswerGroupTransactionBO', 20,
 '{0} {1}', 'ProductTransaction_key,AnswerGroupDetail_key')
