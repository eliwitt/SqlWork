select olorno, olline, olprdc, olords, aya4nb as "MFG NU", ayavst, aybrnb, aybpnb, thz3delv, thz3crrc, thz3pstc,
 	case
...
where olorno in (10127698, 10128252, 10130643, 10130739, 10130781)
order by olorno