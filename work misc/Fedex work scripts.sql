--
-- scripts to update the data to test the estimated delievery date
--
SELECT * FROM table(VTCUSTOMTT.udtf0001t('C00001',20150501,20150512,'C', '' )) as t where ordqty > 0

select * from vt2662aftt.z3optrh where thcstrcn = 625168378288
--update vt2662aftt.z3optrh set thz3pstc = '', thz3pstd ='', thz3delv = '' where thcstrcn = 625168378288
